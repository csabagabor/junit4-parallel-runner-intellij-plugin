...
public class SimpleRunnerExecutor extends DefaultRunExecutor {

    public static final String RUN_WITH_VISUAL_VM = "Run in Parallel";
    public static final String RUN_WITH_VISUAL_VM1 = "RunInParallel";
